...
var actionCategories = []struct {
	...
	{[]string{"access", "read", "fetch", "view"}, "Access"},
	{[]string{"modif", "update", "change", "configur", "patch"}, "Configuration Change"},
	{[]string{"api", "request", "invoke"}, "API Activity"},
	{[]string{"credential", "token", "secret", "password", "certif"}, "Credential"},
	{[]string{"deploy", "launch", "provision"}, "Deployment"},
