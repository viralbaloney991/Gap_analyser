...
export default function AlertInsights({ data, report, insightsError = false, client }: Props) {
  ...
  // Sync localReport when the initial async report prop arrives.
      ...
      <div className="insights-grid">
        ...
        <div className="insights-panel">
          ...
          <div className="insights-panel-section">
            ...
            {effectiveReport ? (
              effectiveReport.strengths?.length ? (
                effectiveReport.strengths.map((s, i) => (
          ...
          <div className="insights-panel-section">
            ...
            {effectiveReport ? (
              effectiveReport.recommendations?.length ? (
                effectiveReport.recommendations.map((r, i) => (
